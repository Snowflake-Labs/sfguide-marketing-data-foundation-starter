...
grant reference_usage on database MARKETING_DATA_FOUNDATION
...
create view if not exists SHARED_CONTENT.C360_CLICKS_CRM_JOINED_VW as
    select *
    from MARKETING_DATA_FOUNDATION.DEMO.C360_CLICKS_CRM_JOINED_VW;

create view if not exists SHARED_CONTENT.CAMPAIGN72_VIEW as
    select *
    from MARKETING_DATA_FOUNDATION.DEMO.CAMPAIGN72_VIEW;
